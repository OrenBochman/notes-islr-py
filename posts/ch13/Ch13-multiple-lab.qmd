...
## Lab Videos {.unnumbered}
The videos for the labs cannot be embedded, here are the links

- [Py Multiple Testing 1 2023](https://www.youtube.com/watch?v=SBeMlJvijbQ) 
- [Py Multiple Testing 2 2023](https://www.youtube.com/watch?v=zvw3AY3Q) 
- [Py Multiple Testing 3 2023](https://www.youtube.com/watch?v=mMFT44ra) 
:::

We imports the usual packages
...
## Below are the new imports
from scipy.stats import (
    ttest_1samp,  # <1>
    ttest_rel,    # <2>
    ttest_ind, # <3>
    t as t_dbn) # <4>
from statsmodels.stats.multicomp import pairwise_tukeyhsd          # <5>
from statsmodels.stats.multitest import multipletests as mult_test # <6>
```

1. **one sample t test** from the `scipy.stats`
2. **two related samples t test** functions from the `scipy.stats`
3. **independent t test** functions from the `scipy.stats`
4. **t test** functions from the `scipy.stats`
5. [pairwise Tukey HSD (honestly significant difference) test](https://www.statsmodels.org/dev/generated/statsmodels.stats.multicomp.pairwise_tukeyhsd.html) from `statsmodels`
6. multipletests from `statsmodels`
