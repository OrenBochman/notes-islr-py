...
This is an appealing method for assessing a fitted Cox
model on a test set.
...
- This is the proportion of pairs for which the model
correctly predicts the relative survival time, among all
pairs for which this can be determined
